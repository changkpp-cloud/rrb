...
- **ทุกครั้งที่แก้โครงสร้าง/flow/หน้า/บทบาทผู้ใช้ → อัปเดต `CLAUDE.md` (และ memory ถ้าเป็นการตัดสินใจถาวร) ให้ตรงกับโค้ดก่อน commit** — ห้ามปล่อยให้เอกสารเก่ากว่าโค้ด
