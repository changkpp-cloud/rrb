...
function getStatusText(status: JobStatus | undefined, imageUrl: string | null | undefined) {
  if (status === "completed" && imageUrl) {
    return {
      ...
      description: "เปิดลิงก์นี้เพื่อบันทึกภาพมอบหรีด AI ลงเครื่อง หรือแชร์ภาพต่อได้เลย",
    };
  }
  ...
  if (status === "failed") {
    return {
      ...
      description: "เปิดลิงก์นี้เพื่อตรวจสอบสถานะ และลองสร้างภาพมอบหรีดใหม่อีกครั้ง",
    };
  }

  return {
    title: "กำลังสร้างภาพมอบหรีด | หรีดร่วมบุญ",
    description: "ระบบกำลังสร้างภาพมอบหรีด AI สามารถเก็บลิงก์นี้ไว้ แล้วกลับมาเปิดเพื่อรับภาพภายหลัง",
  };
}
