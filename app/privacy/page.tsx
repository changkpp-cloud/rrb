    ...
    <main className="min-h-screen flex flex-col bg-cream-50">
      ...
      <div className="mx-auto w-full max-w-2xl flex-1 px-4 py-6 space-y-6">
        ...
        <p className="text-sm leading-7 text-gold-800/85">
          ระบบ <strong>หรีดร่วมบุญ</strong> (“เรา”) ให้บริการจัดการงานฌาปนกิจแบบลดขยะและร่วมบุญผ่านเจ้าภาพโดยตรง
          เราเคารพความเป็นส่วนตัวของผู้ใช้ และเก็บ/ใช้ข้อมูลส่วนบุคคลเท่าที่จำเป็นต่อการให้บริการเท่านั้น
        </p>
        ...
        <Section title="7. ติดต่อเรา">
          <p>
            หากต้องการใช้สิทธิหรือสอบถามเกี่ยวกับข้อมูลส่วนบุคคล โปรดติดต่อผู้ควบคุมข้อมูลส่วนบุคคลของระบบหรีดร่วมบุญ
            ผ่านศูนย์บริหารงานที่ท่านติดต่อ หรือช่องทางที่ระบุไว้ ณ จุดให้บริการ
          </p>
          <p className="text-xs text-gold-500">
            * เอกสารนี้เป็นนโยบายเบื้องต้น ผู้ให้บริการควรปรับชื่อผู้ควบคุมข้อมูลและช่องทางติดต่อให้ตรงกับหน่วยงานจริงก่อนเผยแพร่
          </p>
        </Section>
      </div>
