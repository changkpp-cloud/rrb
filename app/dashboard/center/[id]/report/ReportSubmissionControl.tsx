...
// แสดง/บันทึกสถานะ "ส่งรายงานงวดนี้ให้ อปท. แล้ว"
// ศูนย์ (canMark) กดทำเครื่องหมาย/ยกเลิกได้ · อปท. เห็นสถานะอย่างเดียว
    ...
    return (
      <div className="flex items-center gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-bold text-emerald-800">ส่งรายงาน{periodLabel}ให้ อปท. แล้ว</p>
  ...
  return (
    <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 space-y-2">
      <div className="flex items-center gap-2">
        ...
        <p className="text-xs font-semibold text-amber-800">ยังไม่ได้ทำเครื่องหมายว่าส่งรายงาน{periodLabel}ให้ อปท.</p>
      </div>
      {canMark && (
        <button
        ...
        >
          ...
          ทำเครื่องหมายว่าส่งให้ อปท. แล้ว
        </button>
      )}
